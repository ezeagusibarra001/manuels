...
function Step2(props){
    ...
    const AplyDesc=(e)=>{
        ...
        if(DescValidation){
            ...
            setCurrentClase({ ...currentClase[0].price=currentClase[0].price-currentClase[0].price*0.20});
            addToast(`Código aplicado, transferir: $${currentClase[0].price}`,{appearance: "success",autoDismiss: true,});
...
/*----------------------TRANSFERENCIA BANCARIA----------------------*/
    ...
    return(
        ...
        <div className="ContainerOptions">
            <button className="ButtonOption" onClick={TB}>Transf.Bancaria </button>
            <button className="ButtonOption" onClick={MP}>Mercado Pago    </button>
        </div>
        <div className="CarruselCheckIn">
            <div className="SliderContainer">
                <div className="SlideTB">
                    <p className="TextAbonar">{"Transferir:$"+currentClase[0].price}</p>
                ...
                <div className="SlideMP">
                    ...
                    <div className="DescContainer">
                        ...
                        { DescAplicado
                            ...
                            :<button className="DescButton" onClick={AplyDesc}>Confirmar</button>
                        }
                    </div>
                    <p className="TextLinks">¿Deseas pagar inscripción completa o reservar?</p>
                    <div className="LinksContainer">
                        <a className="ButtonLink" href={currentClase.link1} target="_blank" rel="noreferrer" > Reserva  </a>
                        {DescAplicado
                        ?<a className="ButtonLink" href={currentClase.discountLink}  target="_blank" rel="noreferrer" > Completa </a>
                        :<a className="ButtonLink" href={currentClase.link}          target="_blank" rel="noreferrer" > Completa </a>
                        }
                    </div>
                </div>
            </div>

...
function Checkout() {
  ...
  var ch = document.querySelector(
    "#root > div > div > div.Containercheckout > form > div > span"
  );
        ...
        <form className="ContainerFormcheckout" onSubmit="return false;">
          ...
          <h1 className="CheckoutinputM">
            ...
            {currentClase === undefined ? (
              <OverlayTrigger
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Ha ocurrido un error. Haz click aqui y vuelve a intentarlo.
                  </Tooltip>
                }
              >
                <span className="d-inline-block">
                  <button onClick={home} className="CheckoutButton2">
                    Link no disponible
                  </button>
                </span>
              </OverlayTrigger>
              ...
              <OverlayTrigger
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Link para abonar SOLO la seña parcial de la clase
                  </Tooltip>
                }
              >
                <span className="d-inline-block">
              ...
              <OverlayTrigger
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Link para abonar con codigo promocional aplicado
                  </Tooltip>
                }
              >
                <span className="d-inline-block">
              ...
              <OverlayTrigger
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Link para abonar la clase en su totalidad
                  </Tooltip>
                }
              >
                <span className="d-inline-block">
          ...
          <div className="CheckoutinputCheck">
            ...
            <Form.Check
              type="checkbox"
              onChange={checked}
              label="Para abonar con seña click aqui"
              className="checkBox CheckoutinputM"
            />
          </div>
          ...
          <div className="CheckoutinputCheck2">
            ...
            />
            <Button onClick={getDiscount} className="walletPiola">
              Aplicar Descuento
            </Button>
            <OverlayTrigger
              placement="right"
            ...
            >
              <button className="fix">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  class="bi bi-info-circle-fill x"
                  viewBox="0 0 16 16"
                >
          ...
          <div className="CheckoutinputCheck3">
            <h1 className="Checkouttitle">Elija una fecha</h1>
            {!x[0] ? (
              <div></div>
            ) : (
              <input
          ...
          />
          {fecha.date === "" || currentPayment.phone === "" || file.file == null? (
            <Button
            ...
            <Button className="CheckoutButton" type="button" onClick={submit}>
              {" "}
              Confirmar{" "}
            </Button>
          )}
